...
from hazard.envs.flood.manager import FloodObjectManager
from hazard.envs.flood.utils import *
from hazard.envs.flood.object import AgentStatus
...
class FloorFlood:
    def __init__(self, floor_id):
        ...
        self.height = 0
        self.angles = {"w": 0.0, "x": 0.0, "y": 0.0, "z": 0.0}
...
class FloodController(Controller):
    def __init__(
        ...
        **kwargs
        ...
        self.manager = FloodObjectManager(
